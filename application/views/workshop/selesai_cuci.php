...
<script>
  ...
  var prioritas=$("#prioritas").DataTable({
      ...
      'autoWidth'   : false,
      'ajax'        : {
                      "url"     : "<?php echo site_url()?>Workshop/spesial_list/Proses=4",
                      "dataSrc" : "",
                      "mDataProp": "",   
                      },
      'columns'    :[
      ...
      "columnDefs": [ {
            "targets": -1,
            "data": null,
            "defaultContent": "<button class='btn btn-success'>Selesai</button>"
        } ],
    });
...
var express=$("#express").DataTable({
      ...
      'autoWidth'   : false,
      'ajax'        : {
                      "url"     : "<?php echo site_url()?>Workshop/spesial_list/Proses=5",
                      "dataSrc" : "",
                      "mDataProp": "",   
                      },
      'columns'    :[
...
var semua=$("#semua").DataTable({
      ...
      'autoWidth'   : false,
      'ajax'        : {
                      "url"     : "<?php echo site_url()?>Workshop/semua_kecuali/Proses=4-5",
                      "dataSrc" : "",
                      "mDataProp": "",   
                      },
      'columns'    :[
