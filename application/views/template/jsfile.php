...
<script src="<?php echo site_url('assets/adminlte/bower_components/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/adminlte/bower_components/select2/dist/js/select2.full.min.js')?>"></script>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" src="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
